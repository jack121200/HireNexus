...
class BaseLLMClient(ABC):
    ...
    def __init__(
        ...
        self.logger = logger
        self._request_client = httpx.Client(
...
class GeminiClient(BaseLLMClient):
    ...
    def generate(
        ...
        def _make_request() -> dict[str, Any] | None:
            ...
            response = self._request_client.post(url, json=payload, params=params)
...
class GroqClient(BaseLLMClient):
    ...
    def generate(
        ...
        def _make_request() -> dict[str, Any] | None:
            ...
            response = self._request_client.post(url, json=payload, headers=headers)
            response.raise_for_status()
