    ...
    <div className="space-y-8">
      ...
      {summary && (
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <StatCard label="Resume Score" value={`${summary.resume_score.toFixed(1)}%`} description="Latest eligibility strength" />
          <StatCard label="Jobs Applied" value={summary.jobs_applied} description="Active applications" />
          <StatCard label="Shortlisted" value={summary.jobs_shortlisted} description="Shortlisted by HR" />
          <StatCard
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
        ...
        <Card className="space-y-4">
          ...
          <div className="text-lg font-semibold text-white">Your Practice & AI Sessions</div>
