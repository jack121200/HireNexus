    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1.2fr]">
        <Card className="space-y-4">
          ...
          <div className="rounded-lg border border-border bg-panelMuted p-3 text-xs text-textMuted">
        ...
        <Card className="space-y-4">
          ...
          {resumes.length > 0 && (
            <div className="grid gap-4 md:grid-cols-2">
              {resumes.map((resume) => (
                <div key={resume.id} className="rounded-lg border border-border bg-panelMuted p-4 text-sm">
      ...
      <Card className="space-y-4">
        ...
        {analysis && (
          <div className="grid gap-4 lg:grid-cols-[1.1fr_1fr]">
            <div className="rounded-lg border border-border bg-panelMuted p-4">
